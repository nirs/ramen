...
REGISTRIES = {
    "docker.io": {"port": 5051, "upstream": "https://registry-1.docker.io"},
    "quay.io": {"port": 5052, "upstream": "https://quay.io"},
    "ghcr.io": {"port": 5053, "upstream": "https://ghcr.io"},
    "gcr.io": {"port": 5054, "upstream": "https://gcr.io"},
    "registry.k8s.io": {"port": 5055, "upstream": "https://registry.k8s.io"},
}
